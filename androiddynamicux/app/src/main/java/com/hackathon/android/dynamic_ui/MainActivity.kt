        ...
        setContent {
            AndroiddynamicuxTheme {
                ...
                Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colors.background) {
                    val uiElement: UiElement = Gson().fromJson(json, object : TypeToken<UiElement>() {}.type)
...
//LIST, IMAGE_VIEW,
@Composable
fun BuildView(element: UiElement, data: List<JsonObject?>? = null) = when (element.element) {
